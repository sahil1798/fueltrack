...
function getCoachAdvice() {
  ...
  if (!targets) {
    return { 
      type: 'neutral', 
      title: 'Initializing Coach... 🧠', 
      text: 'Synchronizing your fitness persona and targets. Logging a meal or workout will activate real-time coaching.', 
      item: null 
    };
  }
...
function updateRPG() {
  ...
  for (let i = 0; i < 14; i++) {
    ...
    if (APP.targets && totals.protein >= (APP.targets.protein * 0.8)) vitality += 1;
  }
